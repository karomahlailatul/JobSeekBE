...
const insertWorkExperience = (id, position, company, started, ended, description, users_id) => {
...
const updateWorkExperience = (id, position, company, started, ended, description, users_id) => {
